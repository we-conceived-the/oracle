    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Oracle Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Oracle address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and oracle: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Oracle Core"), this);
    aboutAction->setStatusTip(tr("Show information about Oracle Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Oracle Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Oracle addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Oracle addresses"));
    ...
    openAction->setStatusTip(tr("Open a oracle: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Oracle Core help message to get a list with possible Oracle Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Oracle Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Oracle network", "", count));
}
...
{
    QString strTitle = tr("Oracle Core"); // default title
