    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Oracle Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Oracle Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  oracle-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Oracle in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ORACLE, 0.1 ORACLE, 1 ORACLE and 10 ORACLE -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://Government-of.atlassian.net/wiki/display/DOC/PrivateSend\">https://Government-of.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Oracle Core is shutting down...") + "<br /><br />" +
