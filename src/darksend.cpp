...
{
    if(fLiteMode) return; // ignore all Oracle related functionality
...
/*
    ...
    allow endless transaction that would bloat Oracle and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("oracle-privatesend");
