...
Oracle Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Oracle Core, where everyone uses
...
pay attention to for reviewers of Oracle Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Oracle Core uses tinyformat, which is type safe. Leave them out to avoid confusion
